 ...
 */
public enum RouterType implements RpcEnum {
    RANDOM(0, "random"),
    ...
    RouterType(int code, String description) {
        this.code = code;
    ...
    public static RouterType fromCode(int code) {
    ...
    public static RouterType fromDescription(String description) {
        for (RouterType routerType : values()) {
