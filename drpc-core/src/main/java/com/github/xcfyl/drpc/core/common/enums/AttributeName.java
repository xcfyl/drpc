 ...
 */
public enum AttributeName implements RpcEnum {
    ...
    AttributeName(int code, String description) {
        this.code = code;
    ...
    public static AttributeName fromCode(int code) {
        for (AttributeName attrName : values()) {
    ...
    public static AttributeName fromDescription(String description) {
        for (AttributeName attrName : values()) {
