 ...
 */
public enum ServerConfigName implements RpcEnum {
    ...
    ServerConfigName(int code, String description) {
        this.code = code;
    ...
    public static ServerConfigName fromCode(int code) {
        for (ServerConfigName configName : values()) {
    ...
    public static ServerConfigName fromDescription(String description) {
        for (ServerConfigName configName : values()) {
